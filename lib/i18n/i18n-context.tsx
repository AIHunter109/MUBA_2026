...
const translations: Record<AppLanguage, Partial<Record<string, string>>> = {
  en: {
    ...
    remitPlan: 'Budget Planner', guardians: 'Guardians', paymentPolicies: 'Payment policies', cancel: 'Cancel', create: 'Create', review: 'Review', save: 'Save', remove: 'Remove', approve: 'Approve', reject: 'Reject', active: 'Active', triggered: 'Triggered', disabled: 'Disabled', enabled: 'Enabled', sentToRecipient: 'Sent to {recipient}',
  ...
  ms: {
    ...
    remitPlan: 'Budget Planner', guardians: 'Penjaga', paymentPolicies: 'Polisi pembayaran', cancel: 'Batal', create: 'Cipta', review: 'Semak', save: 'Simpan', remove: 'Buang', approve: 'Luluskan', reject: 'Tolak', active: 'Aktif', triggered: 'Dicetuskan', disabled: 'Dilumpuhkan', enabled: 'Diaktifkan', sentToRecipient: 'Dihantar kepada {recipient}',
